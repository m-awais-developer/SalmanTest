<!-- //////////////////////////////////////////// -->
<!-- /// SECTION 01: MAIN FOOTER INFORMATION BLOCK // -->
<!-- //////////////////////////////////////////// -->
<div class="container-fluid bg-dark text-light mt-5 py-5">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <!-- Column 3: Secondary Feature Links -->
            <div class="col-lg-3 col-md-6">
                <h4 class="d-inline-block text-primary text-uppercase border-bottom border-5 border-secondary mb-4">
                    Popular Links
                </h4>
            ...
            <!-- Column 4: Newsletter & Social Actions -->
            <div class="col-lg-3 col-md-6">
                <h4 class="d-inline-block text-primary text-uppercase border-bottom border-5 border-secondary mb-4">
                    Newsletter
                </h4>
...
<!-- //////////////////////////////////////////// -->
<!-- /// SECTION 02: COPYRIGHT & UTILITY CREDITS // -->
<!-- //////////////////////////////////////////// -->
<div class="container-fluid bg-dark text-light border-top border-secondary py-4">
    <div class="container">
        <div class="row g-5">
            
            <!-- Site Ownership Copyright Statement -->
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0">&copy; <a class="text-primary" href="#!">Your Site Name</a>. All Rights Reserved.</p>
            </div>
            
            <!-- Developer & Distributor Attributes -->
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0">
                    Designed by <a class="text-primary" href="https://htmlcodex.com" target="_blank">HTML Codex</a>. 
